...
class LoadTest(HttpUser):
    ...
    def add_produto(self):
        ...
        produto = {
            ...
            'descricao': 'Uma Geladeira economica baseado em consumo de energia',
            'marca': 'Brastemp',
            'preco': '130.00'
        }
    ...
    def busca_produto(self):
        """ Fazendo uma busca por produtos que no tem o termo "Geladeira".
        """
        # configurando a requisição
        response = self.client.get('busca_produto?termo=Geladeira')
